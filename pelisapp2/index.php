...
$rutasPelis = [
    ...
    "Alta"        => "ctlPeliAlta",
    "Insertar"    => "ctlPeliInsertar",
    "Detalles"    => "ctlPeliDetalles",
    "Modificar"   => "ctlPeliModificar",
    "Borrar"      => "ctlPeliBorrar",
    "Cerrar"      => "ctlPeliCerrar",
    "VerPelis"    => "ctlPeliVerPelis",
    "BuscarTitulo" => "ctlPeliBuscarTitulo",
    "BuscarGenero" => "ctlPeliBuscarGenero",
    "BuscarDirector" => "ctlPeliBuscarDirector",
    "Votar" => "ctlPeliVotar",
    "ImprimirPDF" => "ctlPeliImprimirPDF",
    "ImprimirJSON" => "ctlPeliImprimirJSON",
];
